...
class Consultas_model extends CI_Model
{
    ...
    //obtenemos todos los prodctos disponibles en la tabla billing_producto*/
    public function get_producto_all()
    {       $tot_reservas = $this->ci->generic_model->get_all( 'billing_producto', '*');
           return $tot_reservas;
    }

    /* El stock total del producto se encuentra directamente en la tabla billing_producto */
    public function get_stock($product_id) {
        $res = $this->generic_model->get_val_where('billing_producto', array('codigo'=>$product_id),'stockactual', null, 0);
        return $res;       
    }
