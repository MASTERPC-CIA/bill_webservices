...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
     ...
     */
    public function _fire_method($method, $args)
    {
     ...
     * @return string
     */
    public function _xss_clean($val, $process)
    {
        if (CI_VERSION < 2) {
     ...
     * @return boolean
     */
    public function _check_login($username = '', $password = FALSE)
    {
        if (empty($username)) {
            return FALSE;
        }
     ...
     * @return  array
     */
    public function _force_loopable($data)
    {
    ...
    public function _log_access_time()
    {
    ...
    public function _log_response_code($http_code)
    {
